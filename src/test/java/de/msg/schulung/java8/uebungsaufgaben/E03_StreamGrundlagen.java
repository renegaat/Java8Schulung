...
public class E03_StreamGrundlagen {
	...
	public void bildePersonNameList() {
		...
		final List<String> personenNamen = personListe.stream()
				.map(person -> person.getNachname()).collect(Collectors.toList());
	...
	public void filterPersonsOlderThan18Sort() {
		...
		// - alle Personen, die älter als 18 sind aus der personListe filtert und
		// - die verbleibenden Personen nach ihrem Nachnamen sortiert.
		// Ergebnis ist also eine Liste aller Personen, die älter als 18 sind,
		// sortiert nach ihrem Nachnamen.
	...
	public void pruefeOlder60() {
		...
		// TODO ersetze true durch einen Ausdruck, der anhand eines Streams über personListe ermittelt, ob es
		// in der Liste eine Person gibt, die älter als 60 Jahre ist.
