 ...
 * beginnt.
 * a)	Implementiere die Gruppierung mit Hilfe von konventionellen Java-Mitteln.
...
public class E05_GruppierungMitStreams {
	...
	public void testGruppierePersonenNachAnfangsbuchstabeMitStreams() {
		...
		final Map<Character, List<Person>> gruppierung =
				personenliste.stream().collect(Collectors.groupingBy(person -> person.getNachname().charAt(0)));
